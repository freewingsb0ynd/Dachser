...
public class MapChosenScreen extends Screen {
    ...
    BufferedImage campaignImage, customMapImage, homeImage;
    Rectangle campaignRect, customMapRect, homeRect;
    ...
    public MapChosenScreen(GameWindow gameWindow) {
        ...
        loadImage();
        firstButtonLocation = new Point(this.gameWindow.windowSize.width / 2 - this.buttonSize.width / 2, 300);
        makeRect();
    }
